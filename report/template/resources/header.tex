...
\newcommand{\SeitenrandUnten}{60mm}
\newcommand{\FusszeileHoehe}{0mm}
...
\KOMAoptions{%
    toc=graduated, % keine Einrückungen im Inhaltsverzeichnis
...
\renewcommand*{\addchaptertocentry}[2]{%
  \iftocfeature{toc}{chapteratlist}{}{%
    \addtocontents{toc}{\protect\vspace{0pt}}% extra Abstand vor Kapitelüberschriften in Inhaltsverzeichnis entfernen
  }%
